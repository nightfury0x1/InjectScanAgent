...
| File | Description |
|---|---|
| [`mock_rest_sqli_sqli.html`](https://htmlpreview.github.io/?https://github.com/nightfury0x1/InjectScanAgent/blob/main/sample_results/mock_rest_sqli_sqli.html) | SQLi agent on REST endpoints |
